...
const Section2 = ({ scrollYProgress }) => {
    ...
    return (
        <motion.div style={{ scale, rotate, zIndex: 2 }} className='sticky top-0 bg-secondary h-[120vh] text-2xl flex items-center text-white overflow-hidden py-[20vh]'>
            <div className='w-10/12 mx-auto bg-grey rounded-lg p-4 md:py-8 md:px-6 shadow-2xl shadow-black'>
                <div className='flex flex-col md:flex-row'>
                    <div className='md:w-6/12 md:p-4 flex flex-col items-center overflow-hidden'>
                        <img src={rein} alt='SERVICE PROVIDER WEB' height={400} width={400} className='mb-8 border-white border-2 rounded-md shadow-md object-cover object-center' />
                        <h1 className='text-base md:text-4xl my-2 md:my-8 font-extrabold text-darkBlue'>SERVICE PROVIDER WEB</h1>
                    ...
                    <div className='md:w-6/12 mt-0 md:mt-8 py-4 md:p-4 md:space-y-6 flex flex-col justify-center'>
                        <div className='space-y-1 md:space-y-4'>
                            <h2 className='text-base md:text-3xl font-bold text-darkBlue'>Key Features</h2>
                        ...
                        <div className='space-y-1 md:space-y-4 hidden md:block'>
                            <h2 className='text-3xl font-bold text-darkBlue'>Technologies Used</h2>
                            <div className='flex flex-wrap gap-2 text-base'>
                                <span className='bg-darkBlue text-white rounded-full px-4 py-2'>WordPress</span>
                                <span className='bg-darkBlue text-white rounded-full px-4 py-2'>PHP</span>
                                <span className='bg-darkBlue text-white rounded-full px-4 py-2'>Theme Forest</span>
                            </div>
                        </div>
                        <div className='flex justify-start space-x-4'>
                            <GlowingButton className={'md:text-base text-xs bg-grey text-darkBlue border-darkBlue'}>
