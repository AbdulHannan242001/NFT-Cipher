...
const Section1 = ({ scrollYProgress }) => {
    ...
    return (
        <motion.div style={{ scale, rotate }} className='sticky top-0 bg-primary md:h-[120vh] text-2xl flex items-center justify-center text-textPrimary py-[20vh] overflow-hidden'>
